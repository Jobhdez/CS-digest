...
\begin{abstract}
This document represent lecture notes for a set of computer science textbooks that cover the core of the computer science degree curriculum at the University of Washington in Seattle. The fundamentals of the curriculum include: CSE 143 Computer Programming 2, CSE 311, 312 Discrete math, CSE 331 Software Design and Implementation, Introduction to Algorithms, and CSE 351 Hardware/Software Interface; while the core of the Udub  CS curriculum include about 8 upper level courses. In these lecture notes I will cover compilers, and operating systems.
\end{abstract}
