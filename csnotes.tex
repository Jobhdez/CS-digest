...
\subsubsection{Data Path timing}
Recall from above what a data path is and here is a quote from Dr. Tanenbaum about data path timing: "The timing of these events is shown in Fig. 4-3. Here a short pulse is produced
